...
# Save to xml file
VerticesMappingIO.save_file(vertices_mappings, ".", f"./data/vertices_mapping.vmp")
File(f"./data/mesh.xml") << mesh
File(f"./data/subdomains.xml") << subdomains
File(f"./data/boundaries.xml") << boundaries
